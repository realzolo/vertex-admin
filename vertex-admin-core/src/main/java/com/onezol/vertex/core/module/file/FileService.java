package com.onezol.vertex.core.module.file;
...
@Service
public class FileService extends GenericServiceImpl<FileDetailMapper, FileDetailEntity> implements FileRecorder {
